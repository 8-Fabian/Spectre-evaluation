...
extern victim_func_addr     ; Call address in C program
extern bounds
extern x
extern target_array
...
vulnerable_instruction:
    mov rax, [rsi]           ; Memory load that can speculatively load secret 
...
reset_PHR_loop:    ; reset PHR to all zeros
    ...
    lea r8, [rel x]              ; Code that should be exploitable with spectre v2
